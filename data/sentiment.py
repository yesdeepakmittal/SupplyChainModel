...
documents_ = open('models/documents.pickle','rb')
documents = pickle.load(documents_)
documents_.close()

word_features_ = open('models/word_features5k.pickle','rb')
